...
func EnableObservability() error {
	...
	// Please see https://github.com/reapchain/reapchain/v4/issues/84
	// return nil
	// }

	// pe, err := prometheus.NewExporter(prometheus.Options{
	// 	Namespace: "reapchaind",
	// })
	// if err != nil {
	...
	// // TODO: Derive the Prometheus observability exporter from the Reapchain config.
	// addr := ":8877"
	// go func() {
