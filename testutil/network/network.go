...
func DefaultConfig() Config {
	...
	return Config{
		...
		ChainID:           fmt.Sprintf("reapchain_%d-1", tmrand.Int63n(9999999999999)+1),
		NumValidators:     4,
...
// NewAppConstructor returns a new Reapchain AppConstructor
func NewAppConstructor(encodingCfg params.EncodingConfig) AppConstructor {
	return func(val Validator) servertypes.Application {
		return app.NewReapchain(
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		nodeDir := filepath.Join(network.BaseDir, nodeDirName, "reapchaind")
		clientDir := filepath.Join(network.BaseDir, nodeDirName, "reapchaincli")
