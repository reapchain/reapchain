...
// source: reapchain/inflation/v1/inflation.proto
...
// The initial InflationDistribution can be calculated from the Reapchain Token
// Model like this:
...
type InflationDistribution struct {
	...
	StakingRewards github_com_reapchain_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=staking_rewards,json=stakingRewards,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Dec" json:"staking_rewards"`
	// usage_incentives defines the proportion of the minted minted_denom that is
	// to be allocated to the incentives module address
	UsageIncentives github_com_reapchain_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=usage_incentives,json=usageIncentives,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Dec" json:"usage_incentives"`
	// community_pool defines the proportion of the minted minted_denom that is to
	// be allocated to the community pool
	CommunityPool github_com_reapchain_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=community_pool,json=communityPool,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Dec" json:"community_pool"`
}
...
func (*InflationDistribution) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff0b1bfb731fa17f, []int{0}
}
...
type ExponentialCalculation struct {
	// initial value
	A github_com_reapchain_cosmos_sdk_types.Dec `protobuf:"bytes,1,opt,name=a,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Dec" json:"a"`
	// reduction factor
	R github_com_reapchain_cosmos_sdk_types.Dec `protobuf:"bytes,2,opt,name=r,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Dec" json:"r"`
	// long term inflation
	C github_com_reapchain_cosmos_sdk_types.Dec `protobuf:"bytes,3,opt,name=c,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Dec" json:"c"`
	// bonding target
	BondingTarget github_com_reapchain_cosmos_sdk_types.Dec `protobuf:"bytes,4,opt,name=bonding_target,json=bondingTarget,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Dec" json:"bonding_target"`
	// max variance
	MaxVariance github_com_reapchain_cosmos_sdk_types.Dec `protobuf:"bytes,5,opt,name=max_variance,json=maxVariance,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Dec" json:"max_variance"`
}
...
func (*ExponentialCalculation) Descriptor() ([]byte, []int) {
	return fileDescriptor_ff0b1bfb731fa17f, []int{1}
}
...
func init() {
	proto.RegisterFile("reapchain/inflation/v1/inflation.proto", fileDescriptor_ff0b1bfb731fa17f)
}

var fileDescriptor_ff0b1bfb731fa17f = []byte{
	// 372 bytes of a gzipped FileDescriptorProto
	,
}
