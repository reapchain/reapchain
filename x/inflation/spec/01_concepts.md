...
## reapchain Token Model

The reapchain Token Model outlines how the reapchain network is secured through a
balanced incentivized interest from users, developers and validators. In this
model, inflation plays a major role in sustaining this balance.
...
daily provision of reapchain tokens is minted and allocated to staking rewards,
