...
Say, there are several incentives that have registered an allocation for the $reapchain coin and the allocation meter for $reapchain is at 97%. Then a new incentve proposal can only include an $reapchain allocation at up to 3%, claiming the last remaining allocation capcaity from the $reapchain rewards in the inflation pool.
