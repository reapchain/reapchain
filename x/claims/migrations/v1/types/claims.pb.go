...
func init() {
	proto.RegisterEnum("reapchain.claims.migration.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "reapchain.claims.migration.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "reapchain.claims.migration.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "reapchain.claims.migration.v1.ClaimsRecord")
}
