...
var (
	now  = time.Now().UTC()
	acc1 = sdk.MustAccAddressFromBech32("reap1qxx0fdsmruzuar2fay88lfw6sce6emamyuy86kv7")
	acc2 = sdk.MustAccAddressFromBech32("reap1nsrs4t7dngkdltehkm3p6n8dp22sz3mccw4ur9")
)
