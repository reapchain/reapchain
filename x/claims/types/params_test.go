...
func TestParamsValidate(t *testing.T) {
	testCases := []struct {
		...
		{
			"success - constructor",
			NewParams(true, "treap", time.Unix(0, 0), DefaultDurationOfDecay, DefaultDurationUntilDecay, DefaultAuthorizedChannels, DefaultEVMChannels),
			false,
		},
	}
