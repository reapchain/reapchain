...
//	paramsproposal "github.com/reapchain/cosmos-sdk/x/params/types/proposal"
...
//		marshaler, keyGov, getSubspace(paramsKeeper, govtypes.ModuleName).WithKeyTable(govtypes.ParamKeyTable()), accountKeeper, bankKeeper, stakingKeeper, govRouter, distKeeper,
//	)
//
...
//}
//
//func MakeTestEncodingConfig() simmappparams.EncodingConfig {
