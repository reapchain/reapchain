...
type Valset struct {
	...
	RewardAmount github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,4,opt,name=reward_amount,json=rewardAmount,proto3,customtype=github.com/reapchain/cosmos-sdk/types.Int" json:"reward_amount"`
