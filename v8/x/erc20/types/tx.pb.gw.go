...
var (
	pattern_Msg_ConvertCoin_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"reapchain", "erc20", "v1", "tx", "convert_coin"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Msg_ConvertERC20_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"reapchain", "erc20", "v1", "tx", "convert_erc20"}, "", runtime.AssumeColonVerbOpt(false)))
)
