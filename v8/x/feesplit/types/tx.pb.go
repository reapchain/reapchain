...
func (*MsgRegisterFeeSplit) Descriptor() ([]byte, []int) {
	return fileDescriptor_940b6858bf7fbf74, []int{0}
}
...
func (*MsgRegisterFeeSplitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_940b6858bf7fbf74, []int{1}
}
...
func (*MsgUpdateFeeSplit) Descriptor() ([]byte, []int) {
	return fileDescriptor_940b6858bf7fbf74, []int{2}
}
...
func (*MsgUpdateFeeSplitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_940b6858bf7fbf74, []int{3}
}
...
func (*MsgCancelFeeSplit) Descriptor() ([]byte, []int) {
	return fileDescriptor_940b6858bf7fbf74, []int{4}
}
...
func (*MsgCancelFeeSplitResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_940b6858bf7fbf74, []int{5}
}
...
func init() {
	proto.RegisterType((*MsgRegisterFeeSplit)(nil), "reapchain.feesplit.v1.MsgRegisterFeeSplit")
	proto.RegisterType((*MsgRegisterFeeSplitResponse)(nil), "reapchain.feesplit.v1.MsgRegisterFeeSplitResponse")
	proto.RegisterType((*MsgUpdateFeeSplit)(nil), "reapchain.feesplit.v1.MsgUpdateFeeSplit")
	proto.RegisterType((*MsgUpdateFeeSplitResponse)(nil), "reapchain.feesplit.v1.MsgUpdateFeeSplitResponse")
	proto.RegisterType((*MsgCancelFeeSplit)(nil), "reapchain.feesplit.v1.MsgCancelFeeSplit")
	proto.RegisterType((*MsgCancelFeeSplitResponse)(nil), "reapchain.feesplit.v1.MsgCancelFeeSplitResponse")
}

func init() { proto.RegisterFile("reapchain/feesplit/v1/tx.proto", fileDescriptor_940b6858bf7fbf74) }

var fileDescriptor_940b6858bf7fbf74 = []byte{
	// 448 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) RegisterFeeSplit(ctx context.Context, in *MsgRegisterFeeSplit, opts ...grpc.CallOption) (*MsgRegisterFeeSplitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/reapchain.feesplit.v1.Msg/RegisterFeeSplit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateFeeSplit(ctx context.Context, in *MsgUpdateFeeSplit, opts ...grpc.CallOption) (*MsgUpdateFeeSplitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/reapchain.feesplit.v1.Msg/UpdateFeeSplit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelFeeSplit(ctx context.Context, in *MsgCancelFeeSplit, opts ...grpc.CallOption) (*MsgCancelFeeSplitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/reapchain.feesplit.v1.Msg/CancelFeeSplit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterFeeSplit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/reapchain.feesplit.v1.Msg/RegisterFeeSplit",
	}
...
func _Msg_UpdateFeeSplit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/reapchain.feesplit.v1.Msg/UpdateFeeSplit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CancelFeeSplit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/reapchain.feesplit.v1.Msg/CancelFeeSplit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "reapchain.feesplit.v1.Msg",
	...
	Metadata: "reapchain/feesplit/v1/tx.proto",
}
