...
## Connect Evmos account to Remix

::: tip
If you haven’t already, follow the steps in the [Metamask guide](../keys-wallets/metamask.md) to import your Evmos private key into Metamask. Start the Reapchain Daemon and REST server.
:::
...
Now that your account is connected, you are able to deploy the contract. Press the `Deploy` button. A metamask pop-up will appear asking you to confirm. Confirm the transaction. You should see a log for the deployment transaction in the Reapchain Daemon logs:
