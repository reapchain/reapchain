...
Build the `reapchaind` binary deterministically using Docker. {synopsis}
...
``` bash
git clone git@github.com:reapchain/reapchain.git
```
...
Files:
 7594279acff34ff18ea9d896d217a6db  reapchaind-0.4.0-linux-amd64
 c083e812acbfa7d6e02583386b371b93  reapchaind-0.4.0.tar.gz
Checksums-Sha256:
 d087053050ce888c21d26e40869105163c5521cb5b291443710961ac0c892e81  reapchaind-0.4.0-linux-amd64
 6ca3e5e40240f5e433088fd9b7370440f3f94116803934c21257e1c78fb9653d  reapchaind-0.4.0.tar.gz
```
