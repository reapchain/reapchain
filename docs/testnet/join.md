...
```bash
reapchaind config chain-id evmos_9000-3
```
...
```bash
reapchaind init <your_custom_moniker> --chain-id evmos_9000-3
```
...
wget -P ~/.reapchaind/config https://github.com/tharsis/testnets/raw/main/evmos_9000-3/genesis.zip
