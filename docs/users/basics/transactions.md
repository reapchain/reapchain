...
Learn more about transactions on reapchain {synopsis}
...
<!-- 
TODO: explain what transactions are on reapchain and blockchains. 
...
<!-- TODO: explain which transactions types does reapchain support (i.e modules and changes) and provide a few examples. -->
...
reapchain supports the following Ethereum transactions.
