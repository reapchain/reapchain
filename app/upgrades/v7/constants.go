...
const (
	...
	UpgradeInfo = `'{"binaries":{"darwin/arm64":"https://github.com/reapchain/reapchain/releases/download/v7.0.0/evmos_7.0.0_Darwin_arm64.tar.gz","darwin/x86_64":"https://github.com/reapchain/reapchain/releases/download/v7.0.0/evmos_7.0.0_Darwin_x86_64.tar.gz","linux/arm64":"https://github.com/reapchain/reapchain/releases/download/v7.0.0/evmos_7.0.0_Linux_arm64.tar.gz","linux/x86_64":"https://github.com/reapchain/reapchain/releases/download/v7.0.0/evmos_7.0.0_Linux_x86_64.tar.gz","windows/x86_64":"https://github.com/reapchain/reapchain/releases/download/v7.0.0/evmos_7.0.0_Windows_x86_64.zip"}}'`
